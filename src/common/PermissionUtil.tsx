...
export const APP_PERMISSION_CODE = {
    "location": [PERMISSIONS.ANDROID.ACCESS_FINE_LOCATION, PERMISSIONS.ANDROID.ACCESS_COARSE_LOCATION, PERMISSIONS.IOS.LOCATION_ALWAYS, PERMISSIONS.IOS.LOCATION_WHEN_IN_USE],
    "bluetooth": [PERMISSIONS.ANDROID.BLUETOOTH_SCAN, PERMISSIONS.ANDROID.BLUETOOTH_CONNECT, PERMISSIONS.IOS.BLUETOOTH],
...
class PermissionUtil {
     ...
     * @returns 
     */
    cmmReqPermissions = async (permsArr: Permission[]): Promise<void> => {
        console.log("[+] 함수 실행완료")
